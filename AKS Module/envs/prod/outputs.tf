...
# Spot Node Pool Outputs
output "spot_node_pool_id" {
  description = "Spot node pool ID"
  value       = var.create_spot_node_pool ? module.spot_node_pool[0].node_pool_id : null
}

output "spot_node_pool_name" {
  description = "Spot node pool name"
  value       = var.create_spot_node_pool ? module.spot_node_pool[0].node_pool_name : null
}
